...
Handles GlobalEvents and AvaGlobalState for the "Day in the Life" simulation.
"""
...
class GlobalEvents(Base):
    ...
    These represent significant events in Ava's daily life.
    """
...
class AvaGlobalState(Base):
    """
    Extended global state tracking for Ava's persistent attributes.
    This extends the existing AvaState model with simulation-specific traits.
    """
    __tablename__ = "ava_global_state"
    ...
    def __repr__(self):
        return f"<AvaGlobalState(trait='{self.trait_name}', value='{self.value}', numeric='{self.numeric_value}')>"
